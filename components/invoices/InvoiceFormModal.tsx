...
const InvoiceFormModal: React.FC<InvoiceFormModalProps> = ({ isOpen, onClose, invoice, prefilledData }) => {
    ...
    const { subTotal, totalDiscount, totalTax, totalWithholding, grandTotal } = useMemo(() => {
        let subTotal = 0, totalDiscount = 0, totalTax = 0, grandTotal = 0, totalWithholding = 0;
        ...
        grandTotal = subTotal - totalDiscount + totalTax - totalWithholding;
        return { subTotal, totalDiscount, totalTax, totalWithholding, grandTotal };
