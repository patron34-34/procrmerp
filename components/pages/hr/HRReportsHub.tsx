...
import { HR_REPORT_CARDS } from '../../../constants';

const HRReportsHub: React.FC = () => {
    return (
        <div>
            <div className="mb-6">
                <h1 className="text-3xl font-bold text-text-main dark:text-dark-text-main">İK Rapor Merkezi</h1>
                <p className="text-text-secondary dark:text-dark-text-secondary mt-1">İnsan kaynakları verilerinizi analiz ederek stratejik kararlar alın.</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {HR_REPORT_CARDS.map((report) => (
