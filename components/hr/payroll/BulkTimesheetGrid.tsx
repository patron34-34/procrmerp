...
const PuantajInput: React.FC<{
    ...
    <input
        ...
        disabled={!isEditable}
        className="w-24 p-1 border border-transparent hover:border-slate-300 focus:border-primary-500 rounded-md text-right bg-transparent focus:bg-white dark:focus:bg-slate-700 transition-colors"
    />
);
