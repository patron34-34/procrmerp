...
interface CustomerRelatedListsProps {
    customerId: number;
    // Actions are now handled in the header, these can be removed
    onAddNewDeal: () => void;
